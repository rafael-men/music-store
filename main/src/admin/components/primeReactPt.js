...
export const inputDisabledClass = 'w-full bg-gray-900 border border-gray-800 rounded-lg px-3 py-2 text-sm text-gray-500 placeholder-gray-700 cursor-not-allowed'
